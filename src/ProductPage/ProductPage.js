    ...
    <section className="page-width product-container">
      ...
      <div className="product-description">
        ...
        <div className="social-icons">
          ...
          <div>
            <a className="icon icon-twitter" href="https://twitter.com/intent/tweet?text=Hello%20world" data-size="large">
          ...
          <div>
            <a className="icon icon-pin" href="https://www.pinterest.com/pin/create/button/" data-pin-do="buttonBookmark" data-pin-custom="false">
